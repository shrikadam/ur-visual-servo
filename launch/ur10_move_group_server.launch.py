...
def generate_launch_description():
    ...
    # SRDF
    robot_srdf = load_file("ur_gz","resource/ur10_moveit_config/ur10.srdf")
    robot_description_semantic = {"robot_description_semantic": robot_srdf}

    # Kinematics
    kinematics = load_yaml("ur_gz","resource/ur10_moveit_config/kinematics.yaml")

    # Joint limits
    joint_limits_yaml = load_yaml("ur_gz", "resource/ur10_moveit_config/joint_limits.yaml")
    joint_limits = {"robot_description_planning": joint_limits_yaml}

    # Planning
    ompl_yaml = load_yaml("ur_gz","resource/ur10_moveit_config/ompl_planning.yaml")
    planning = {"move_group": {
